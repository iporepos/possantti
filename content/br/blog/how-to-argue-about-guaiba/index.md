...
> Leia também: [Como não argumentar sobre o Guaíba]({{< ref "blog/how-to-not-argue-about-guaiba" >}})

## Deduções, gaúchos e polêmicas

As falácias argumentativas listadas no post anterior estão erradas porque elas violam a [lógica de inferência dedutiva](https://en.wikipedia.org/wiki/Deductive_reasoning).
...
A sentença consequente é _implicada_ pela premissa e pelo antecedente. No caso das falácias, não está implicado, por exemplo, que o Guaíba é um rio ou um lago só porque a população prefere de um jeito, ou porque a lei protege mais um ou outro.

{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Fata_Morgana_effect_at_Guaiba_Lake.jpg/960px-Fata_Morgana_effect_at_Guaiba_Lake.jpg" caption="Uma Fata Morgana no Lago Guaíba. Ipanema, Inverno de 2019" credit="© Iporã Possantti" >}}


### Hipóteses falsas

O filósofo [Karl Popper](https://pt.wikipedia.org/wiki/Karl_Popper) nos ensina que a dedução é muito útil na Ciência, pois a premissa consiste em uma hipótese e o antecedente consiste em uma **evidência empírica refutadora**. Por exemplo:
...
A _confirmação_ de uma hipótese é bem mais complicada, pois uma evidência empírica confirmativa específica não garante a verdade de uma hipótese mais abrangente:
...
Para confirmar a hipótese, **todos** os gaúchos precisariam ser entrevistados, enquanto que _apenas um_ gaúcho que _não_ gosta de polêmicas é suficiente para demonstrar que a hipótese é falsa.

{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Shallow_water_in_Guaiba_Lake_shore.jpg/500px-Shallow_water_in_Guaiba_Lake_shore.jpg" caption="Ingazeiros e o Lago Guaíba. Menino Deus, Outono de 2025" credit="© Iporã Possantti" width="70%" >}}
...
Esse tipo de problema demanda que seja instanciada uma coleção de objetos substantivos _a priori_, definidos de maneira exaustiva e mutuamente excludente. Ou seja: _gatos não podem ser cachorros ao mesmo tempo_. 

Da mesma forma, rios não podem ser lagos. Lagos não podem ser estuários. Uma coisa é uma coisa, outra coisa é outra coisa.

{{< img src="https://images.possantti.net/reproduced/misc/atchoum-cat.jpg" caption="Gato ou cachorro? Se é um, não pode ser outro" credit="https://www.atchoumthecat.com/" width="50%" >}}
...
Se eu precisar toda a vez explicar nos mínimos detalhes as sensações bizarras que assolam o meu estômago, nunca irei almoçar. É muito mais prático falar que “_tenho fome_”.
...
Pelo olhar da física, é necessário apenas instanciar um universo com algumas coisas bem simples, como os conceitos de **tempo, espaço e massa**; as três leis de Newton; e talvez algumas constantes, como a aceleração da gravidade e a viscosidade do fluido. O resultado disso são as [equações de Navier-Stokes](https://en.wikipedia.org/wiki/Navier%E2%80%93Stokes_equations):

$$
\rho \left( \frac{\partial \mathbf{u}}{\partial t} + \mathbf{u} \cdot \nabla \mathbf{u} \right) = - \nabla p + \mu \nabla^2 \mathbf{u} + \mathbf{f}
$$

em que $\rho$ é a densidade do fluido (kg/m³), $\mathbf{u}$ é o vetor velocidade (m/s), $t$ é o tempo (s), $p$ é a pressão (Pa), $\mu$ é a viscosidade dinâmica (Pa·s), $\nabla$ é o operador gradiente, e $\mathbf{f}$ representa forças externas (N/m³). Essas equações podem ser simplificadas em diferentes situações, [como para o escoamento de águas rasas](https://en.wikipedia.org/wiki/Shallow_water_equations).
...
{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Stage_levels_at_Guaiba_Lake.jpg/960px-Stage_levels_at_Guaiba_Lake.jpg" caption="Réguas de nível no Lago Guaíba. Ipanema, Inverno de 2019" credit="© Iporã Possantti"  >}}
...
Com esse protocolo, eu vejo que o Guaíba não pode ser um rio porque a classe de “rio” _não passa no teste_ em nenhum sistema de classificação razoável. Eu explico.
...
{{< img src="https://images.possantti.net/reproduced/figures/rosgen-fig1.jpg" caption="Tipologias de rios, com base na declividade, seção e vista de plano" credit="Rosgen (1994)" width="70%" >}}

Nessa linha, podemos definir um rio da seguinte maneira:

> “**Um rio é um canal drenável.**”

Assim sendo, os rios criam sistemas fluviais de erosão, transporte e deposição. Em trechos mais declivosos, formam _remansos e corredeiras_. Em áreas mais planas, criam-se as _barras_ (depósitos) e _barrancas_ (erosão). _Meandros_ avulcionam em planícies sedimentares, o que resulta em diques naturais e lagoas de ferraduras (meandros ambandonados).
...
{{< img src="https://images.possantti.net/reproduced/figures/grotzinger-meanders.jpg" caption="Estrutura de um sistema fluvial" credit="Grotzinger et al.(2014)" width="70%" >}}

Porém, no caso do Guaíba, as evidências de batimetria divulgadas por Nicolodi e colegas (2011) apontam que não existe declividade efetiva, pois o seu fundo está **abaixo do nível do mar**. Em alguns locais, o fundo chega a estar até mesmo 10 metros de profundidade _abaixo_ do nível do Oceano.
...
{{< img src="https://images.possantti.net/story/story-guaiba-depth.jpg" caption="Batimetria normal (mapa de profundidade) do Lago Guaíba." credit="modificado de Nicolodi et al. (2011)" width="70%" >}}

{{< img src="https://images.possantti.net/story/story-guaiba-depth-dry.jpg" caption="Estimativa de profundidade se o Lago Guaíba “secar” 1 metro." credit="© Iporã Possantti" width="70%" >}}
...
{{< img src="https://images.possantti.net/remote-sensing/guaiba-plume.jpg" caption="Uma corrente de fluxo de água mais escura (com menos lama) adentrando o Guaíba, ainda tomado de águas turvas. Nota-se uma zona relativamente estagnada no Saco Santa Cruz, próximo de Eldorado do Sul. Março de 2025" credit="modificado de INPE" width="70%" >}}

O **apelo ao fluxo** é um argumento legítimo, pois é geofísico. Porém, na minha opinião, esse argumento incorre num [engano de categorização](https://en.wikipedia.org/wiki/Category_mistake), pois confunde a definição de corrente de fluxo com a definição de rio. Ou seja, se estabelece que:
...
{{< img src="https://images.possantti.net/remote-sensing/estuary-patos.jpg" caption="Correntes de fluxo no Estuário da Laguna dos Patos (RS), Maio de 2024" credit="modificado de INPE" width="70%" >}}

No Oceano existem diversas correntes de fluxo, que então seriam rios. Até mesmo as [correntes de turbidez](https://en.wikipedia.org/wiki/Turbidity_current) seriam rios. Da mesma forma, as correntes de fluxo que adentram nos lagos de represas artificias, por definição, também seriam rios.

{{< img src="https://images.possantti.net/remote-sensing/primavera-lake.jpg" caption="Corrente de fluxo na foz do Rio Pardo no lago da represa Porto Primavera (SP), Outono de 2025" credit="modificado de ESA" width="70%" >}}
...
Estudos conduzidos com o DMAE no final dos anos 90 trouxeram amplas evidências sobre os sedimentos de fundo do Guaíba. A conclusão é que o teor de areia no seu centro, _justamente por onde passa a famosa corrente de fluxo_, é de de 0 a 10%.

{{< img src="https://images.possantti.net/reproduced/figures/sechi-sedimentos-guaiba.jpg" caption="Sedimentos do fundo do Lago Guaíba" credit="Sechi et al. (2000)" width="70%" >}}

Nessa área, a maior parte dos sedimentos é de [silte](https://pt.wikipedia.org/wiki/Silte), uma fração lamosa e fina de sedimentos, que precisa de águas tranquilas para se depositar. Isso implica que, mesmo com a corrente de fluxo atravessando o lago, predominam condições tranquilas para a deposição abaixo da superfície.
...
{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Sandy_beach_at_Guaiba_Lake_shore.jpg/960px-Sandy_beach_at_Guaiba_Lake_shore.jpg" caption="Praia arenosa no Lago Guaíba. Ipanema, Inverno de 2019" credit="© Iporã Possantti" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/nicolodi-ressuspension.jpg" caption="Mapa do potencial de ressuspensão de silte e areia fina pela ação de ondas no Lago Guaíba." credit="Nicolodi et al. (2013)" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/nicolodi-sed_environments.jpg" caption="Mapa dos ambientes sedimentares do Lago Guaíba" credit="Nicolodi et al. (2013)" width="70%" >}}
...
Eles mediram a vazão com sensores ao longo da seção do canal, mostrando que geralmente o fluxo ali é intenso e positivo, trazendo água nova do Delta para dentro do Lago. Mas quando o vento sul é suficientemente forte, a corrente _se inverte_, e há um fluxo negativo de água, que escoa do Lago para dentro do Delta.

{{< img src="https://images.possantti.net/reproduced/figures/scotta-q_pos.jpg" caption="Fluxo negativo medido na Ponta da Cadeia (Gasômetro)" credit="Scottá et al. (2020)" >}}
