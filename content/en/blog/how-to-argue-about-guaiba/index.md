...
> Read also: [How not to argue about the Guaíba]({{< ref "blog/how-to-not-argue-about-guaiba" >}})

## Deductions, Gaúchos and controversies

The argumentative fallacies listed in the previous post are wrong because they violate the [logic of deductive inference](https://en.wikipedia.org/wiki/Deductive_reasoning).
...
1. **premise**: it is true that all gaúchos like a controversy;
2. **antecedent**: it is true that Joana is a gaúcha;
3. **consequent**: then it is true that Joana likes a controversy.
...
{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Fata_Morgana_effect_at_Guaiba_Lake.jpg/960px-Fata_Morgana_effect_at_Guaiba_Lake.jpg" caption="A Fata Morgana at Guaíba Lake. Ipanema, Winter 2019" credit="© Iporã Possantti" >}}

### False hypotheses

The philosopher [Karl Popper](https://en.wikipedia.org/wiki/Karl_Popper) teaches us that deduction is very useful in Science, as the premise consists of a hypothesis and the antecedent consists of **refuting empirical evidence**. For example:

1. **hypothesis**: all gaúchos like controversies;
2. **refuting evidence**: Mateus is a gaúcho, but he doesn't like controversies;
3. **conclusion**: then the hypothesis that all gaúchos like controversies is false.
...
1. **broad hypothesis**: all gaúchos like controversies;
2. **specific confirmatory evidence**: José is a gaúcho and likes controversies;
3. **conclusion**: then the hypothesis remains open, as it refers to all gaúchos, not just José.
...
{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Shallow_water_in_Guaiba_Lake_shore.jpg/500px-Shallow_water_in_Guaiba_Lake_shore.jpg" caption="Ingazeiros and the Guaíba Lake. Menino Deus, Autumn 2025" credit="© Iporã Possantti" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/misc/atchoum-cat.jpg" caption="Cat or dog? If it is one, it cannot be the other" credit="https://www.atchoumthecat.com/" width="50%" >}}
...
From the perspective of physics, it is only necessary to instantiate a universe with a few very simple things, such as the concepts of **time, space and mass**; Newton's three laws; and perhaps some constants, such as the acceleration of gravity and the viscosity of the fluid. The result of this is the [Navier-Stokes equations](https://en.wikipedia.org/wiki/Navier%E2%80%93Stokes_equations):

$$
\rho \left( \frac{\partial \mathbf{u}}{\partial t} + \mathbf{u} \cdot \nabla \mathbf{u} \right) = - \nabla p + \mu \nabla^2 \mathbf{u} + \mathbf{f}
$$

where $\rho$ is the fluid density (kg/m³), $\mathbf{u}$ is the velocity vector (m/s), $t$ is time (s), $p$ is pressure (Pa), $\mu$ is dynamic viscosity (Pa·s), $\nabla$ is the gradient operator, and $\mathbf{f}$ represents external forces (N/m³). These equations can be simplified in different situations, [such as for shallow water flow](https://en.wikipedia.org/wiki/Shallow_water_equations).
...
{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Stage_levels_at_Guaiba_Lake.jpg/960px-Stage_levels_at_Guaiba_Lake.jpg" caption="Level gauges at Guaíba Lake. Ipanema, Winter 2019" credit="© Iporã Possantti"  >}}
...
1. choose a system of classes;
2. collect empirical evidence about the object;
3. for each class, test the evidence against the class definition;
4. if the evidence contradicts the class definition, reject that class.
...
{{< img src="https://images.possantti.net/reproduced/figures/rosgen-fig1.jpg" caption="River typologies, based on slope, cross-section and plan view" credit="Rosgen (1994)" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/grotzinger-meanders.jpg" caption="Structure of a fluvial system" credit="Grotzinger et al.(2014)" width="70%" >}}
...
{{< img src="https://images.possantti.net/story/story-guaiba-depth.jpg" caption="Normal bathymetry (depth map) of Guaíba Lake." credit="modified from Nicolodi et al. (2011)" width="70%" >}}

{{< img src="https://images.possantti.net/story/story-guaiba-depth-dry.jpg" caption="Estimated depth if Guaíba Lake “dries” by 1 metre." credit="© Iporã Possantti" width="70%" >}}
...
{{< img src="https://images.possantti.net/remote-sensing/guaiba-plume.jpg" caption="A darker water flow current (with less mud) entering the Guaíba, still taken by murky waters. A relatively stagnant zone is noted in Saco Santa Cruz, near Eldorado do Sul. March 2025" credit="modified from INPE" width="70%" >}}

The **appeal to flow** is a legitimate argument, as it is geophysical. However, in my opinion, this argument incurs a [category mistake](https://en.wikipedia.org/wiki/Category_mistake), as it confuses the definition of flow current with the definition of river. That is, it establishes that:
...
{{< img src="https://images.possantti.net/remote-sensing/estuary-patos.jpg" caption="Flow currents in the Laguna dos Patos Estuary (RS), May 2024" credit="modified from INPE" width="70%" >}}

In the Ocean there are several flow currents, which would then be rivers. Even [turbidity currents](https://en.wikipedia.org/wiki/Turbidity_current) would be rivers. Similarly, flow currents entering artificial dam lakes would, by definition, also be rivers.

{{< img src="https://images.possantti.net/remote-sensing/primavera-lake.jpg" caption="Flow current at the mouth of the Pardo River in the Porto Primavera dam lake (SP), Autumn 2025" credit="modified from ESA" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/sechi-sedimentos-guaiba.jpg" caption="Sediments from the bottom of Guaíba Lake" credit="Sechi et al. (2000)" width="70%" >}}

In this area, most of the sediment is [silt](https://en.wikipedia.org/wiki/Silt), a muddy and fine fraction of sediment, which needs calm waters to deposit. This implies that, even with the flow current crossing the lake, calm conditions predominate for deposition below the surface.

The sand content increases around the mouth of the Jacuí Delta and on both margins of the lake, where it can reach 100%.

{{< img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Sandy_beach_at_Guaiba_Lake_shore.jpg/960px-Sandy_beach_at_Guaiba_Lake_shore.jpg" caption="Sandy beach at Guaíba Lake shore. Ipanema, Winter 2019" credit="© Iporã Possantti" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/nicolodi-ressuspension.jpg" caption="Map of the resuspension potential of silt and fine sand by wave action in Guaíba Lake." credit="Nicolodi et al. (2013)" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/nicolodi-sed_environments.jpg" caption="Map of the sedimentary environments of Guaíba Lake" credit="Nicolodi et al. (2013)" width="70%" >}}
...
{{< img src="https://images.possantti.net/reproduced/figures/scotta-q_pos.jpg" caption="Negative flow measured at Ponta da Cadeia (Gasômetro)" credit="Scottá et al. (2020)" >}}
